...
class MetricLogger:
    ...
    def display_status(self, epoch, num_epochs, batch_idx, num_batches, crt_loss,
        ...
        :param crt_loss: ``torch.autograd.Variable``, discriminator loss
        ...
        print('Discriminator Loss: {:.4f}, Generator Loss: {:.4f}'.format(crt_loss, gen_loss))
